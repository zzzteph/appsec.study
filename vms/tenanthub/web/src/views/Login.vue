...
async function submit() {
  ...
  try { const d = await post(tab.value === 'login' ? '/auth/login' : '/auth/register', f.value); setAuth(d.access, d.user); router.push(route.query.next || '/') }
...
<template>
  <div class="auth">
    <div class="box">
      <div class="center" style="flex-direction:column;gap:8px;margin-bottom:22px"><img :src="logo(48)" width="48" height="48" /><h1 style="margin:0">TenantHub</h1><div class="muted">Team workspace</div></div>
      <div class="card">
