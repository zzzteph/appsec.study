<template>
  <div class="auth">
    <div class="card">
      <div class="logo" style="margin-bottom:16px"><span class="m"></span> FrontDesk</div>
      <h1>Sign in</h1>
      <p class="muted" style="margin:0 0 18px">Manage your bookings and loyalty perks.</p>
      ...
      <p class="muted" style="margin-top:16px;font-size:13px">Demo account: <code>demo</code> / <code>demo</code></p>
    </div>
  </div>
</template>
<script setup>
