// maze store: fetch /api/manifest, expose views + endpoints, provide REST helpers keyed to /api.
...
export const state = reactive({
  ...
  session: '',          // session cookie value (maze_sid=...)
  cart: 0,
})
