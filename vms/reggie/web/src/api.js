...
// references /api/run — the RCE surface appears only after you register + log in. Auto-refreshes the
// 1-minute access token on 401.
const A = '/api'
const getAccess = () => localStorage.getItem('rg_access')
const getRefresh = () => localStorage.getItem('rg_refresh')
