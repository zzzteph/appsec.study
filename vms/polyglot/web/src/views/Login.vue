...
const tab = ref('login'); const f = ref({ username: '', password: '', email: '', name: '' }); const err = ref(''); const busy = ref(false)
...
<template>
  <div class="auth">
    <div class="box">
      <div class="center" style="flex-direction:column;gap:8px;margin-bottom:20px"><img :src="logo(48)" width="48" height="48" /><h1 style="margin:0">Polyglot</h1><div class="muted">Localization platform</div></div>
      <div class="card">
