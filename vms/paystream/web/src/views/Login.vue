...
<template>
  <div class="auth">
    <div class="box">
      <div class="center" style="flex-direction:column;gap:8px;margin-bottom:20px"><img :src="logo(48)" width="48" height="48" /><h1 style="margin:0">Paystream</h1><div class="muted">HR & Payroll</div></div>
      <div class="card">
