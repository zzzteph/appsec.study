...
<template>
  ...
  <div v-if="me" class="grid g2" style="align-items:start">
    <div class="card">
      <div class="row" style="margin-bottom:12px"><img class="avatar" :src="avatar(me.username, 52)" width="52" height="52" /><div><h3 style="margin:0">{{ me.name }}</h3><span class="muted">{{ me.title }} · {{ me.department }}</span></div></div>
      ...
      <div class="row" style="margin-top:14px"><span class="muted">Base salary</span><b>${{ me.salary }}</b></div>
    </div>
