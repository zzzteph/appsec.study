...
const TOKEN = 'int-mutie-6b1e0f'

app.get('/', (req, res) => res.json({
  service: 'mutie-internal', endpoints: { 'GET /token': 'issue task token', 'POST /run-task': 'run task (X-Task-Token, {cmd})' }
}))
...
function start() { app.listen(9000, '127.0.0.1', () => console.log('mutie internal svc on 127.0.0.1:9000')) }
