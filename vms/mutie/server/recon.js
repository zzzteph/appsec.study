...
function mountRecon(app, mut) {
  ...
  const rootSpec = { openapi: '3.0.0', info: { title: 'mutie public API', version: '1.0' }, paths: { '/health': { get: { summary: 'health' } }, '/status': { get: { summary: 'status' } } } }
  app.get(['/openapi.json', '/swagger.json'], (q, s) => s.json(rootSpec))
  app.get('/swagger', (q, s) => s.type('html').send('<!doctype html><title>API docs</title><h1>mutie API</h1><p>See <a href="/openapi.json">/openapi.json</a>.</p>'))
