...
<form method="POST" enctype="multipart/form-data" action="{{route('update-course',['course_id' => $course->id])}}">
...
<article class="message is-danger">
  ...
  <div class="message-body">
			<form method="POST" action="{{route('delete-course',['course_id' => $course->id])}}">
